...
min_loss = []
max_loss = []
fileName = open("ExperimentResults.csv",'r')
...
bar_colors[13] = 'crimson'
bar_hatches[13] = "//"

fig, ax = plt.subplots()
ax.bar(names,average_acc, color=bar_colors, linewidth=1.25, edgecolor='black', hatch=bar_hatches)
ax.set_ylabel("Accuracy (%)",fontsize=16)
ax.set_xlabel("Parameter Set",fontsize=16)
